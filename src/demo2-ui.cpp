	  ...
	  try
	    {
	      ...
	      const std::string filename = "US_Carbon_Emissions.dat";
	  ...
	  try
	    {
	      ...
	      const std::string filename = "tornado_intensity.dat";
	  ...
	  try
	    {
	      ...
	      const std::string filename = "tornado_data_3D.dat";
	      const std::string title = "Tornado Intensity Data";
	      const unsigned int column_x = 1;
	      const unsigned int column_y = 2;
	  ...
	  try
	    {
	      ...
	      const std::string filename = "ocean_temp.dat";
